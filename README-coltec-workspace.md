# Coltec Workspace: coltec-codespaces-dev

This workspace wraps the asset repo at `codebase/` and layers on Coltec tooling for **coltec/coltec-codespaces** (Monorepo (polyglot)).

## Directory Structure

```
coltec-codespaces-dev/
├── .devcontainer/
